...
public class TowMap extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mapServiceAvailable()) {
            ...
            setContentView(R.layout.activity_tow_map);
        ...
        engage = findViewById(R.id.bt_engaged);

        engage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TowMap.this, Login.class);
    ...
    private void showMap() {
        fragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.tow_map);
        fragment.getMapAsync((OnMapReadyCallback) this);
    }
    public boolean mapServiceAvailable() {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerOptions masenoMech = new MarkerOptions()
                .title("Maseno Garage")
                .icon(BitmapDescriptorFactory.fromResource(R.mipmap.towingmap_foreground))
